# work_dir = './work_dirs/ada/round_1'
# load_from = './work_dirs/segformer_prototypes_mit-b5_2x1_1024x1024_160k_gta/iter_160000.pth'
# seg_map_path = 'tmp/100_40_1'
# ann_file = 'tmp/100_40_1.txt' # li afegeix data_root per davant
# max_iters = 5000 # 20000
dataset_type = 'CityscapesDataset'
data_root = 'data/cityscapes'
lr = 2e-5 # 2e-5
lr_mult = 10.0 # 10.0
begin_poly = 0 # 0 500 1500
val_interval = 1000
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            img_path='leftImg8bit/val', seg_map_path='gtFine_val_8bits'),
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='Resize', scale=(2048, 1024), keep_ratio=True),
            dict(type='LoadAnnotations'),
